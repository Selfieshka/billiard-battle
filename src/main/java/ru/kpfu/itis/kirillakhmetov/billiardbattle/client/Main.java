...
//
//
//        GameScene2 gameScene = new GameScene2(gameGroup, game, menu, root5, window, outToServer, inFromServer, controller);
//        gameScene.startGame();
//        MenuScene menuScene = new MenuScene2(menuGroup, primaryStage, menu, credits, rules);

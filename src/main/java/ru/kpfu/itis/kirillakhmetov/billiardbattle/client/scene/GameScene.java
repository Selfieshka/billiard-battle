...
public class GameScene {
    ...
    public GameScene(Group group, Scene scene, Scene menu, Parent root, Stage window, PrintWriter outToServer, BufferedReader inFromServer, GameController gameController) throws Exception {
...
//        SoundEffects.volume = SoundEffects.Volume.LOW;
    ...
    public void initializeBalls() {
        ball[4] = new SingleBall(865, 325, "/img/ballimages/4.png", 1, 4);
        ball[12] = new SingleBall(865, 350, "/img/ballimages/12.png", 2, 12);
        ball[3] = new SingleBall(865, 375, "/img/ballimages/3.png", 1, 3);
        ball[9] = new SingleBall(865, 400, "/img/ballimages/9.png", 2, 9);
        ball[7] = new SingleBall(865, 425, "/img/ballimages/7.png", 1, 7);

        ball[1] = new SingleBall(841, 338, "/img/ballimages/1.png", 1, 1);
        ball[15] = new SingleBall(841, 363, "/img/ballimages/15.png", 2, 15);
        ball[2] = new SingleBall(841, 388, "/img/ballimages/2.png", 1, 2);
        ball[5] = new SingleBall(841, 413, "/img/ballimages/5.png", 1, 5);

        ball[14] = new SingleBall(817, 350, "/img/ballimages/14.png", 2, 14);
        ball[8] = new SingleBall(817, 375, "/img/ballimages/8.png", 3, 8);
        ball[10] = new SingleBall(817, 400, "/img/ballimages/10.png", 2, 10);

        ball[11] = new SingleBall(793, 363, "/img/ballimages/11.png", 2, 11);
        ball[6] = new SingleBall(793, 388, "/img/ballimages/6.png", 1, 6);

        ball[13] = new SingleBall(769, 375, "/img/ballimages/13.png", 2, 13);

        ball[0] = new SingleBall(346, 375, "/img/ballimages/0.png", 0, 0);
    ...
    private void moveCueBall() {
        ball[0].getSphere().addEventHandler(MouseEvent.MOUSE_DRAGGED, event -> {
            if (isTurn && isFoul && player1.isMyturn()) {
                ...
                gameController.dirLine1.setVisible(false);

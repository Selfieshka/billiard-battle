 ...
 *     <li>{@link #START_ACTIVE_PLAYER_LIST} - Команда для обозначения начала передачи списка активных игроков.</li>
 *     <li>{@link #ACTIVE_PLAYER_LIST} - Команда для передачи списка активных игроков.</li>
 *     <li>{@link #END_ACTIVE_PLAYER_LIST} - Команда для обозначения окончания передачи списка активных игроков.</li>
...
public final class ProtocolProperties {
    ...
    public static final String START_ACTIVE_PLAYER_LIST = "START_ACTIVE_PLAYER_LIST";
    public static final String ACTIVE_PLAYER_LIST = "ACTIVE_PLAYER_LIST";
    public static final String END_ACTIVE_PLAYER_LIST = "END_ACTIVE_PLAYER_LIST";
